...
define('ember-app/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('ember-app/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-app/templates/application.hbs should pass TemplateLint.\n\nember-app/templates/application.hbs\n  22:26  error  Incorrect indentation for `bs-navbar` beginning at L1:C0. Expected `{{/bs-navbar}}` ending at L22:C26 to be at an indentation of 0 but was found at 12.  block-indentation\n  2:14  error  Incorrect indentation for `<div>` beginning at L2:C14. Expected `<div>` to be at an indentation of 2 but was found at 14.  block-indentation\n  7:14  error  Incorrect indentation for `{{#component}}` beginning at L7:C14. Expected `{{#component}}` to be at an indentation of 2 but was found at 14.  block-indentation\n  5:18  error  Incorrect indentation for `{{navbar.toggle}}` beginning at L5:C18. Expected `{{navbar.toggle}}` to be at an indentation of 16 but was found at 18.  block-indentation\n  8:14  error  Incorrect indentation for `<a>` beginning at L8:C14. Expected `<a>` to be at an indentation of 16 but was found at 14.  block-indentation\n  16:21  error  Incorrect indentation for `{{#component}}` beginning at L16:C21. Expected `{{#component}}` to be at an indentation of 18 but was found at 21.  block-indentation\n  17:20  error  Incorrect indentation for `{{#component}}` beginning at L17:C20. Expected `{{#component}}` to be at an indentation of 23 but was found at 20.  block-indentation\n  32:0  error  Incorrect indentation for `<div>` beginning at L32:C0. Expected `<div>` to be at an indentation of 4 but was found at 0.  block-indentation\n  34:8  error  Incorrect indentation for `div` beginning at L32:C0. Expected `</div>` ending at L34:C8 to be at an indentation of 0 but was found at 2.  block-indentation\n');
  });
