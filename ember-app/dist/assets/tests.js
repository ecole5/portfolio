...
define('ember-app/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('ember-app/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-app/templates/index.hbs should pass TemplateLint.\n\nember-app/templates/index.hbs\n  16:12  error  Incorrect indentation for `div` beginning at L2:C4. Expected `</div>` ending at L16:C12 to be at an indentation of 4 but was found at 6.  block-indentation\n  4:8  error  Incorrect indentation for `<div>` beginning at L4:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  12:8  error  Incorrect indentation for `<div>` beginning at L12:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  5:12  error  Incorrect indentation for `<div>` beginning at L5:C12. Expected `<div>` to be at an indentation of 10 but was found at 12.  block-indentation\n  9:20  error  Incorrect indentation for `div` beginning at L5:C12. Expected `</div>` ending at L9:C20 to be at an indentation of 12 but was found at 14.  block-indentation\n  6:16  error  Incorrect indentation for `<h1>` beginning at L6:C16. Expected `<h1>` to be at an indentation of 14 but was found at 16.  block-indentation\n  7:10  error  Incorrect indentation for `<p>` beginning at L7:C10. Expected `<p>` to be at an indentation of 14 but was found at 10.  block-indentation\n  8:10  error  Incorrect indentation for `<p>` beginning at L8:C10. Expected `<p>` to be at an indentation of 14 but was found at 10.  block-indentation\n  13:12  error  Incorrect indentation for `<img>` beginning at L13:C12. Expected `<img>` to be at an indentation of 10 but was found at 12.  block-indentation\n');
  });
