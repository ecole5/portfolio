...
;define("ember-app/templates/contact", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "4gkUy0+u", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"class\",\"container bg-dark\"],[11,\"style\",\"min-height: 100vh; padding-left:0%\"],[9],[0,\"\\n\"],[10],[0,\"\\n\"],[1,[21,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/contact.hbs" } });
});
...
;
          if (!runningTests) {
            require("ember-app/app")["default"].create({"name":"ember-app","version":"0.0.0+eb8ce652"});
          }
